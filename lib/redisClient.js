...
RedisClient.prototype.setMediaByTags = function (tag, media, cacheTime, cb) {
  var self = this
  this._redisClient.setex(self.PREFIX.MEDIA + tag, cacheTime, JSON.stringify(media), cb)
}

RedisClient.prototype.updateTag = function (opts, cb) {
  var self = this
  var tag = opts.tag,
